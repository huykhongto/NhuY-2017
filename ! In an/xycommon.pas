...
uses Windows , {Messages,} SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
		{StdCtrls, Spin,} ExtCtrls, Clipbrd{, AppEvnts}, in_hoa_don,LDNam_sys,
...
procedure chen_hinh_anh(ha:string; w,h:integer);
...
procedure chen_hinh_anh(ha:string; w,h:integer); {XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX}
var //w,h : integer;
		crect : Trect;
begin
//	b_ha:= Tbitmap.create;
...
//	with b_ha do
//    begin
//			//if (ha='1') then pixelformat := pf24bit else
//			//if (ha='2') then 
//			pixelformat := pf32bit;
//      width := w; height := h;
//      crect := rect(0,0,w,h);
...
//    end;
	...
	w := cwidth; h := cheight;
	screencopy.LoadFromFile(duong_dan_goc+'/LDN.bmp');
	with screencopy do
		begin
			pixelformat := pf32bit;
			width := w; height := h;
