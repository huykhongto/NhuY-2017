...
{$R *.dfm}
procedure Tf_ha.dct_1Drop(Sender: TObject; ShiftState: TShiftState;
  APoint: TPoint; var Effect: Integer);
var
  Stream: TStream;
  i: integer;
...
//======================================== 
procedure Tf_ha.them_dl(lua_chon: byte);
var
	ngay_cn:string;
	dong_dl:string;
...
begin
	//so_dong := m_thong_tin.Lines.Count;
	if lua_chon=1 then
	begin
...
//======================================== 
procedure Tf_ha.lv_haMouseDown(Sender: TObject;
...
//---------------------------------------- 
procedure Tf_ha.tm1Timer(Sender: TObject);
begin
	sttb1.Panels[0].Text := '';
	tm1.Enabled := false;
end;
...
//======================================== 
//---------------------------------------- 
procedure Tf_ha.bt_them_vao_cham_congClick(Sender: TObject);
begin
...
procedure Tf_ha.Button2Click(Sender: TObject);
begin
	ma_ha:=tang_chuoi_so_5(ma_ha);
end;

procedure Tf_ha.b_suaClick(Sender: TObject);
begin
...
procedure Tf_ha.b_themClick(Sender: TObject);
begin
	them_dl(1);
end;

procedure Tf_ha.b_xoa_mucClick(Sender: TObject);
begin
...
procedure Tf_ha.cbb_emailChange(Sender: TObject);
begin
	//cbb_gia_ban.Hint:=so_ra_chu(strtoint64(cbb_gia_ban.Text),sai,dung);
end;

procedure Tf_ha.CheckBoxBitmapsClick(Sender: TObject);
begin
...
procedure Tf_ha.CheckBoxDataClick(Sender: TObject);
begin
//  if (TCheckBox(Sender).Checked) then
...
procedure Tf_ha.CheckBoxFilesClick(Sender: TObject);
begin
//  if (TCheckBox(Sender).Checked) then
...
procedure Tf_ha.CheckBoxMetaFilesClick(Sender: TObject);
begin
//  if (TCheckBox(Sender).Checked) then
...
procedure Tf_ha.CheckBoxTextClick(Sender: TObject);
begin
...
procedure Tf_ha.CheckBoxURLsClick(Sender: TObject);
begin
//  if (TCheckBox(Sender).Checked) then
...
procedure Tf_ha.cbb_dia_chiChange(Sender: TObject);
begin
	//cbb_gia_von.Hint:=so_ra_chu(strtoint64(cbb_gia_von.Text),sai,dung);
end;

procedure Tf_ha.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
	luu_thong_so;
end;

procedure Tf_ha.FormCreate(Sender: TObject);
begin
	lb_lv(f_dl.lb_ha,lv_ha);
end;

procedure Tf_ha.ListViewDataDblClick(Sender: TObject);
begin
...
procedure Tf_ha.lv_haColumnClick(Sender: TObject;
	Column: TListColumn);
begin
...
procedure Tf_ha.lv_haCompare(Sender: TObject; Item1,
