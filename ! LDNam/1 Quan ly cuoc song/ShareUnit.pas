...
uses
  ...
  StdCtrls, Buttons, checklst,System.UITypes;
...
//  Appt := f_quan_ly_cuoc_song.JvTFDays1.SelAppt;
//
...
//          f_quan_ly_cuoc_song.JvTFDays1.SelAppt.AssignSchedules(TempList)
//        Else
...
//            With f_quan_ly_cuoc_song.JvTFDays1 do
