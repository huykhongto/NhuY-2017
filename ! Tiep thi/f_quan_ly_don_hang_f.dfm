object f_quan_ly_don_hang: Tf_quan_ly_don_hang
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object lv_don_hang: TListView
      ...
      TabOrder = 0
      ViewStyle = vsReport
      OnColumnClick = lv_don_hangColumnClick
      OnCompare = lv_don_hangCompare
      OnMouseDown = lv_don_hangMouseDown
    end
  end
  object Panel1: TPanel
    ...
    object cbb_nhom_don_hang: TComboBox
      Left = 208
      Top = 5
      Width = 145
      Height = 21
      ...
      OnChange = cbb_nhom_don_hangChange
      Items.Strings = (
  ...
  object Panel4: TPanel
    ...
    Align = alClient
    TabOrder = 3
    object lv_don_hang_tim: TListView
      Left = 1
      Top = 1
      Width = 842
      Height = 102
      ...
      OnColumnClick = lv_don_hangColumnClick
      OnCompare = lv_don_hangCompare
      OnMouseDown = lv_don_hang_timMouseDown
    end
  end
  object tm1: TTimer
    Enabled = False
