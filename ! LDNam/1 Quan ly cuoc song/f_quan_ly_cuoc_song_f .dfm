object f_quan_ly_cuoc_song: Tf_quan_ly_cuoc_song
  Left = 212
  Top = 138
  Caption = 'Qu'#7843'n l'#253' cu'#7897'c s'#7889'ng LDNam'
  ClientHeight = 507
  ClientWidth = 618
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object JvTFDays1: TJvTFDays
        ...
        TimeBlockProps.SelBlockHdrAttr.Font.Charset = ANSI_CHARSET
        ...
        ApptAttr.Font.Charset = ANSI_CHARSET
        ...
        SelApptAttr.Font.Charset = ANSI_CHARSET
        ...
        HdrAttr.Font.Charset = ANSI_CHARSET
        ...
        FancyRowHdrAttr.MinorFont.Charset = ANSI_CHARSET
        ...
        FancyRowHdrAttr.MajorFont.Charset = ANSI_CHARSET
        ...
        SelFancyRowHdrAttr.MinorFont.Charset = ANSI_CHARSET
        ...
        SelFancyRowHdrAttr.MajorFont.Charset = ANSI_CHARSET
        ...
        PrimeTime.StartTime = 0.312500000000000000
        PrimeTime.EndTime = 0.708333333333333000
        PrimeTime.Color = clYellow
        GroupHdrAttr.Font.Charset = ANSI_CHARSET
        ...
        SelGroupHdrAttr.Font.Charset = ANSI_CHARSET
        ...
        Weekend = [dowSunday]
        WeekendColor = clInfoBk
        LeftCol = 0
        TopRow = 5
        OnDateChanging = JvTFDays1DateChanging
        OnDateChanged = JvTFDays1DateChanged
        OnGranularityChanging = JvTFDays1GranularityChanging
        OnGranularityChanged = JvTFDays1GranularityChanged
        OnInsertAppt = JvTFDays1InsertAppt
        OnInsertSchedule = JvTFDays1InsertSchedule
        OnUpdateColTitles = JvTFDays1UpdateColTitles
        DateFormat = 'ddddd'
        TimeFormat = 't'
        Align = alClient
        Color = clWhite
  ...
  object Panel1: TPanel
    ...
    object GotoDatePicker: TDateTimePicker
      ...
      Height = 21
      Hint = 'Current Day'
      Date = 42370.414710879600000000
      Time = 42370.414710879600000000
      ParseInput = True
      ParentShowHint = False
      ShowHint = True
      TabOrder = 10
  ...
  object utfScheduleManager1: TJvTFScheduleManager
    ...
    OnRefreshSched = utfScheduleManager1RefreshSched
    OnRefreshAll = utfScheduleManager1RefreshAll
    ...
    Cache.TimedDelay = 1000
    OnPostApptQuery = utfScheduleManager1PostApptQuery
    OnFlush = utfScheduleManager1Flush
    OnCreateAppt = utfScheduleManager1CreateAppt
    OnDestroyAppt = utfScheduleManager1DestroyAppt
    OnCreateSchedule = utfScheduleManager1CreateSchedule
    OnDestroySchedule = utfScheduleManager1DestroySchedule
    OnLoadBatch = utfScheduleManager1LoadBatch
    OnBatchesProcessed = utfScheduleManager1BatchesProcessed
    OnGetApptDisplayText = utfScheduleManager1GetApptDisplayText
    OnGetApptDescription = utfScheduleManager1GetApptDescription
    OnSetApptDescription = utfScheduleManager1SetApptDescription
  ...
  object StateImageList: TImageList
    ...
    Top = 168
    Bitmap = {
      494C010104000500280010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object JvTFAlarm1: TJvTFAlarm
    ScheduleManager = utfScheduleManager1
    TimerInterval = 1000
    OnAlarm = JvTFAlarm1Alarm
    Left = 372
    Top = 185
  end
end
